---
name: py-xray-paper
description: "Paper X-ray. Extracts what the paper says (problem-perspective-result) and what it means for the reader (cognitive delta cards in ASCII art). Use when user shares an arxiv link, paper URL, PDF, or asks to analyze a research paper. Usually called via py-xray router. Do NOT use for blog posts or non-academic articles (use py-xray-article instead)."
user_invocable: true
---
...
2. 文件名：`{时间戳}--paper-{简短标题}__read.md`
