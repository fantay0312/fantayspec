...
Read `~/.claude/skills/py-card/assets/poster_template.html`
...
写入：`/tmp/py_cast_poster_{name}_{N}.html`

## 步骤 7：截图

```bash
node ~/.claude/skills/py-card/assets/capture.js /tmp/py_cast_poster_{name}_{N}.html ~/Downloads/{name}_{N}.png 1080 1440
```
