...
4. **Evidence-Based Reasoning**—Support claims with source URLs when available. Prefer credible, authoritative sources.
...
5. Include source URLs inline where relevant (e.g., [Source Title](URL)). It is OK to respond without citations if the information is well-established.
