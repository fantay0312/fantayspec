...
Read `~/.claude/skills/py-card/assets/whiteboard_template.html`
...
写入：`/tmp/py_cast_whiteboard_{name}.html`
...
```bash
node ~/.claude/skills/py-card/assets/capture.js /tmp/py_cast_whiteboard_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
