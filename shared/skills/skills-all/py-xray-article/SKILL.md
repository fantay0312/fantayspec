---
name: py-xray-article
description: X-ray scans articles (blog posts, essays, opinion pieces) to extract the real question and cognitive collisions. Use when user shares a non-academic article URL or text for deep structural analysis. Do NOT use for academic papers (use py-xray-paper) or books (use py-xray-book).
user_invocable: true
---

# PY-Xray-Article: 文章解读
...
2. 文件名：`{时间戳}--article-{简短标题}__read.md`
...
- **Markdown 格式**：标准 Markdown，加粗用 `**bold**`
